...
--- Tests for antigravity screen.start2.nobanner
...
_G.TestAntigravityScreenBasicNoBanner = {}

function _G.TestAntigravityScreenBasicNoBanner:setup()
...
function _G.TestAntigravityScreenBasicNoBanner:teardown()
    _G.agScreenController = nil
end

--- Verify refresh generates an SVG and save it as a sample image.
function _G.TestAntigravityScreenBasicNoBanner:testDisplay()
    screenStart1()
    screenStart2()
    screenStart3()
...
function _G.TestAntigravityScreenBasicNoBanner:testDisplayZeroAlt()
    screenStart1()
    screenStart2()
    screenStart3()
    _G.agScreenController.SVG_TEMPLATE = BASE_SVG
...
--- Verify a negative altitude will not crash the display rendering.
function _G.TestAntigravityScreenBasicNoBanner:testDisplayNegativeAlt()
    screenStart1()
    screenStart2()
    screenStart3()
    _G.agScreenController.SVG_TEMPLATE = BASE_SVG
